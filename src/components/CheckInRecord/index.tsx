        ...
        <Form.Item label='入住人姓名'>
          {
            getFieldDecorator('customername', {
              ...
              <Input className='searchstyle' placeholder='请输入入住人姓名'></Input>
            )
          }
        </Form.Item>
        <Form.Item label='入住人身份证'>
          {
            getFieldDecorator('customeridcard', {
              ...
              <Input className='searchstyle' placeholder='请输入入住人身份证'></Input>
            )
          }
        </Form.Item>
        <Form.Item label='房间类型'>
          {
            getFieldDecorator('type', {
              ...
              <Select allowClear={true} className='searchstyle' placeholder='请选择房间类型'>
        ...
        <Form.Item label='装潢类型'>
          {
            getFieldDecorator('decoration',{
              ...
              <Select allowClear={true} className='searchstyle' placeholder='请选择装潢类型'>
